...
public interface UpgradeableSerializable extends ConfigurationSerializable
{
    ...
    @Deprecated
    default void upgrade00451(@NotNull SafeMap map)
    {
        UpgradeableSerialization.deserialize(this, map);
    }

    @Deprecated
    default void upgrade00452(@NotNull SafeMap map)
    {
        UpgradeableSerialization.deserialize(this, map);
    }

    @Deprecated
    default void upgrade00460(@NotNull SafeMap map)
    {
        UpgradeableSerialization.deserialize(this, map);
    }

    @Deprecated
    default void upgrade00470(@NotNull SafeMap map)
    {
        UpgradeableSerialization.deserialize(this, map);
    }

    @Deprecated
    default void upgrade00480(@NotNull SafeMap map)
    {
        UpgradeableSerialization.deserialize(this, map);
    }

    default void upgrade00481(@NotNull SafeMap map)
    {
        UpgradeableSerialization.deserialize(this, map);
    }
