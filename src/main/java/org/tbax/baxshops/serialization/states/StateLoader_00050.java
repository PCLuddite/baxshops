...
public class StateLoader_00050 implements StateLoader
{
    ...
    public StateLoader_00050(ShopPlugin plugin)
    {
        this.plugin = plugin;
    ...
    public BaxShop getBaxShop(Shop shop)
    {
